            ...
            <div class="px-4 py-6 sm:px-0">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-8">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600">Cari dari <span class="font-semibold text-[#1593E6]">{{ $totalKosts }}
                                kost</span> dengan <span class="font-semibold text-[#1593E6]">{{ $availableRooms }}
                                kamar</span> tersedia</p>
                    </div>
                    ...
                    <div class="max-w-4xl mx-auto">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-6">
                            ...
                            <div class="lg:col-span-2">
                                <button onclick="searchKost()"
                                    ...
                                    <svg class="w-5 h-5 mx-auto lg:hidden" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                    </svg>
                        ...
                        <div class="flex flex-wrap gap-2 justify-center">
                            ...
                            <button onclick="quickFilter('Pria')"
                                class="px-3 py-1 bg-blue-50 text-blue-600 rounded-full text-sm font-medium hover:bg-blue-100 transition-colors">
                                Kost Pria
                            </button>
                            <button onclick="quickFilter('Wanita')"
                                class="px-3 py-1 bg-pink-50 text-pink-600 rounded-full text-sm font-medium hover:bg-pink-100 transition-colors">
                                Kost Wanita
                            </button>
                            <button onclick="quickFilter('Campur')"
                                class="px-3 py-1 bg-purple-50 text-purple-600 rounded-full text-sm font-medium hover:bg-purple-100 transition-colors">
                                Kost Campur
                            </button>
                            <button onclick="browseAll()"
                                class="px-3 py-1 bg-gray-50 text-gray-600 rounded-full text-sm font-medium hover:bg-gray-100 transition-colors">
                                Lihat Semua
                            </button>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200 mb-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <a href="{{ route('kost.index') }}"
                            class="flex items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-[#1593E6] hover:bg-[#1593E6]/5 transition-colors group">
                            <div class="text-center">
                                <svg class="w-8 h-8 text-gray-400 group-hover:text-[#1593E6] mx-auto mb-3 transition-colors"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                </svg>
                                <span
                                    class="text-sm font-medium text-gray-600 group-hover:text-[#1593E6] transition-colors">Jelajahi
                                    Semua Kost</span>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('rentals.index') }}"
                            ...
                            <div class="text-center">
                                ...
                                <span
                                    class="text-sm font-medium text-gray-600 group-hover:text-[#1593E6] transition-colors">{{ __('app.view_bookings') }}</span>
                            </div>
                        </a>

                        <button onclick="alert('Sistem pembayaran segera hadir!')"
                            class="flex items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-[#1593E6] hover:bg-[#1593E6]/5 transition-colors group">
                            <div class="text-center">
                                <svg class="w-8 h-8 text-gray-400 group-hover:text-[#1593E6] mx-auto mb-3 transition-colors"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span
                                    class="text-sm font-medium text-gray-600 group-hover:text-[#1593E6] transition-colors">{{ __('app.payments') }}</span>
                            </div>
                        </button>

                        <button onclick="alert('Pengaturan profil segera hadir!')"
                            class="flex items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-[#1593E6] hover:bg-[#1593E6]/5 transition-colors group">
                            <div class="text-center">
                                <svg class="w-8 h-8 text-gray-400 group-hover:text-[#1593E6] mx-auto mb-3 transition-colors"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span
                                    class="text-sm font-medium text-gray-600 group-hover:text-[#1593E6] transition-colors">Pengaturan
                                    {{ __('app.profile') }}</span>
                            </div>
                        </button>
                    </div>
                ...
                @if($featuredKosts->count() > 0)
                    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="{{ route('kost.index') }}"
                                class="text-[#1593E6] hover:text-[#0F7CC8] font-medium text-sm transition-colors">
                                Lihat Semua →
                            </a>
                        </div>
