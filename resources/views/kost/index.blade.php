        ...
        <div class="bg-white border-b">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div class="text-center">
                    ...
                    <p class="text-lg text-gray-600">{{ __('app.comfortable_affordable') }}
                        {{ __('app.ideal_living_space') }}</p>
                </div>
            </div>
        </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 items-center justify-between">
                    <div class="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="searchInput" placeholder="{{ __('app.search_placeholder') }}"
            ...
            @if($kosts->count() > 0)
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    @foreach($kosts as $kost)
                        <div
                            class="bg-white rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-200">
                            <!-- Image -->
