            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="facilities" id="facilities-hidden" value="{{ old('facilities', $kost->facilities) }}">
                        @error('facilities')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Tekan <kbd>Enter</kbd> untuk menambah item</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="rules" id="rules-hidden" value="{{ old('rules', $kost->rules) }}">
                        @error('rules')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Tekan <kbd>Enter</kbd> untuk menambah item</div>
